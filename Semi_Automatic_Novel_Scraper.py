...
f"Perfected_Novels_{genre}_Data.csv")
...
try:
    sorted_folder = input("Please Enter Name For Folder:")
...
try:
    shutil.move(f"Perfected_Rating_{genre}.csv",os.path.join(sorted_folder,f"Perfected_Rating_{genre}.csv"))
    shutil.move(f"Perfected_Chapters_{genre}.csv",os.path.join(sorted_folder,f"Perfected_Chapters_{genre}.csv"))
